...
std_msgs::Bool sensor_mode_msg;
int temperature_gas_mode = 0;
...
void ConnectROS(int argc, char** argv)
{
	...
	pub_value_2 = nodehandle.advertise<std_msgs::Int16>("arduino_value_2", 1);
  	pub_sensor_mode = nodehandle.advertise<std_msgs::Bool>("sensor_mode", 1);
