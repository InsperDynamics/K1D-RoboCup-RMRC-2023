...
static void InitializeQR() 
{
	...
	scanner.set_config(ZBAR_QRCODE, ZBAR_CFG_X_DENSITY, 100);
	scanner.set_config(ZBAR_QRCODE, ZBAR_CFG_Y_DENSITY, 100);
	scanner.set_config(ZBAR_QRCODE, ZBAR_CFG_MIN_LEN, 1);
	scanner.set_config(ZBAR_QRCODE, ZBAR_CFG_MAX_LEN, 100);
